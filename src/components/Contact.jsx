...
import { Mail, Phone, MapPin, Linkedin, Github, Send, Loader2, CheckCircle2, AlertTriangle, MessageCircle } from 'lucide-react'
...
export default function Contact() {
  ...
  const handleWhatsApp = () => {
    const lines = [
      `Hi Kevin, my name is ${form.name || '___'}.`,
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-[#25D366]/15 border border-[#25D366]/40 text-[#25D366] font-display font-semibold text-sm tracking-wide transition-all duration-300 hover:bg-[#25D366]/25 hover:-translate-y-0.5"
              >
